...
import com.tomas.cubesolver.bfs.Search;
import com.tomas.cubesolver.neuralnetwork.Solve;
import com.tomas.cubesolver.utils.Utils;


/**
 * Implements any size NxNxN rubik's cube.
 */
public class Cube implements Search, Solve {
	 ...
	 * @return the moves perform in String sequence
	 */
	...
	//Below Methods Performs each turn
		...
		for(int ch = 0; ch < trainInput.length(); ch++){
			...
			switch(curr){
				...
				case 'O':
					...
					break;
				default:
					throw new IllegalArgumentException("Invalid character in training input");
			}
		}
		return input;
	}
