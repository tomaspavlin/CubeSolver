...
/**
 * The interface for objects that can be trained using a training algorithm as stochastic back propagation.
 * The example of such object is NN (neural network).
 */
